...
#Silver Creek only
#useLocations=st_intersection(allLocations,st_read("~/Dropbox/SilverCreek/SilverCreekSpatial/StaticData/silverCreekWatershedExtent.gpkg"))
...
wshedsInfo=sapply(useLocationsList,calcWshed)
